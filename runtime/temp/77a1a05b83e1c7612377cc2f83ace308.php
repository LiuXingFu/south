<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\php\Apache24\htdocs\South/application/index\view\index\register.html";i:1561649705;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            if (countdown == 0) {
                ...
                if (countdown == 60){
                    ...
                    if(yzmtel != ''){
                        ...
                        xmlHttp.open("GET", "ucpaastest?yzmtel="+yzmtel, true);
                        xmlHttp.send(null);
                    }else {
                        //手机号为空
